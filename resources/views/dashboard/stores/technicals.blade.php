...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>فنيين فرع <small style="font-size:bold;">{{ $store->name}}</small></h1>
                            ...
                            @foreach ($technicals as $index=>$technical)
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <form action="{{ route('dashboard.technicals.destroy', $technical->id) }}" method="post" style="display: inline-block">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
