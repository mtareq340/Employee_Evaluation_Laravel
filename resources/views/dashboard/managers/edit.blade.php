    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.managers.index') }}">المديرين</a></li>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.managers.update', $manager->id) }}" method="post">
                        ...
                        {{ method_field('put') }}
                            ...
                            <div class="form-group">
                                <label>الاسم</label>
                                <input type="text" name="name" class="form-control" value="{{ $manager->name }}">
                            </div>
                            <div class="form-group">
                                <label>العنوان</label>
                        ...
                        <div class="form-group">
                            ...
                            <select name="store_id" class="form-control">
                                ...
                                @foreach ($stores as $store)
                                    <option value="{{ $store->id }}" {{ $manager->store_id == $store->id ? 'selected' : '' }}>{{ $store->name }}</option>
                                @endforeach
                            </select>
                        </div>
