...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <h1>تقييمات الزيارة للمدير  <small style="font-size:bold;">{{ $manager->name}}</small></h1>

            <ol class="breadcrumb">
                <li><a href="{{ route('dashboard.welcome') }}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
                <li><a href="{{ route('dashboard.visits.managers', [$store_id, $visit_id]) }}"><i class="fa fa-dashboard"></i> فنيين الزيارة</a></li>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.managers.marks') }}" method="post">

                        {{ csrf_field() }}
                        {{ method_field('post') }}

                        @if ($proberties->count() > 0)
                        <input style="display:none; " type="text" name="manager_id" value="{{ $manager_id }}">
